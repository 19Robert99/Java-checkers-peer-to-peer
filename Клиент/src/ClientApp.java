...
public class ClientApp extends JFrame {
	...
	public ClientApp() {
		...
		try {
			...
			String name =JOptionPane.showInputDialog(null, "Enter port to Connect", "Connect to Server",
					JOptionPane.WARNING_MESSAGE);


			if (name != null && name.length() > 0) {
				playerName = JOptionPane.showInputDialog(null, "Enter your name", "Registration Successful",
						JOptionPane.WARNING_MESSAGE);
